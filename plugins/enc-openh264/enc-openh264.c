...
static void *openh264_create(obs_data_t *settings, obs_encoder_t *encoder)
{
    ...
    enc_oh264->param.iTargetBitrate = 6000000;
    ...
    //(*enc_oh264->openh264_encoder)->SetOption(ENCODER_OPTION_MAX_BITRATE, &bitrate);
		...
		struct encoder_packet *packet, bool *received_packet)
{
    ...
    *received_packet = (info.sLayerInfo[info.iLayerNum].iNalCount != 0);
